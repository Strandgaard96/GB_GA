...
for m in range(n_runs):
    ...
    args = [population_size, file_name, scoring_script, scaling_function, generations, mating_pool_size,
            mutation_rate, crossover_rate, scoring_args, prune_population, n_cpus, sa_screening, randomseed, n, dest_dir]
    # Run the GA
    GA(args)
    t1 = time.time()
