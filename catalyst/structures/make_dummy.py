...
reactant3d_opt, energy = xtb_optimize(reactant3d, charge=Chem.GetFormalCharge(reactant3d), scratchdir='.', name='prereactant', remove_tmp=False)
# %%
quart_amine = Chem.MolFromSmarts('[#7X4;H0;D4;+1]')
...
# %%
writer = Chem.SDWriter('/home/julius/soft/GB-GA/catalyst/structures/prereactant_dummy.sdf')
